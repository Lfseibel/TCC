...
use App\Http\Controllers\{BlockController, CalendarController, IndexController, ReservationController, RoomController, ScheduleController, UnityController, UserController};
...
Route::middleware('auth')->group(function(){
    ...
    Route::middleware('reservationAccess')->group(function(){
        Route::get('/reservations', [ReservationController::class, 'index'])->name('reservation.index');
        Route::delete('/reservation/{code}', [ReservationController::class, 'destroy'])->name('reservation.destroy');
        Route::match(['put', 'patch'], '/verify/reservation/{code}', [ReservationController::class, 'verify'])->name('reservation.verify');
